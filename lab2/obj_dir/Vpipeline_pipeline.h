...
class alignas(VL_CACHE_LINE_BYTES) Vpipeline_pipeline final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ __PVT__my_FE_stage__DOT__hash_FE;
    CData/*0:0*/ __PVT__my_FE_stage__DOT__prediction_FE;
    CData/*0:0*/ __PVT__my_FE_stage__DOT__BTB_hit;
    ...
    CData/*0:0*/ __PVT__my_AGEX_stage__DOT__br_mispred_AGEX;
    ...
    VlWide<6>/*169:0*/ __PVT__my_FE_stage__DOT__FE_latch;
    ...
    IData/*31:0*/ __PVT__my_FE_stage__DOT__j;
    IData/*31:0*/ __PVT__my_FE_stage__DOT__predicted_target;
    ...
    VlWide<6>/*169:0*/ __Vdly__my_FE_stage__DOT__FE_latch;
    IData/*31:0*/ __Vdlyvval__my_MEM_stage__DOT__dmem__v0;
    QData/*58:0*/ my_FE_stage__DOT____VdfgTmp_hccac35d1__0;
