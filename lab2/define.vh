...
/** please update the following define with your own values */ 
 ...
 `define FE_latch_WIDTH  (8 + 1 + 32 + 1 + `INSTBITS+`DBITS+ `DBITS + `DBITS)
  `define DE_latch_WIDTH  (8 + 1 + 32 + 1 + `INSTBITS+`DBITS+`DBITS+ `IOPBITS + `DBITS + `DBITS + `DBITS + `DBITS + 1 + 1 + 1 + 1 + 1 + `REGNOBITS)
  ...
  `define from_AGEX_to_FE_WIDTH (1 + 8 + 32 + 1 + 1 + 1 + `DBITS)
