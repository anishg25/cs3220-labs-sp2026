...
wire full = ((wr_ptr_gray_reg[ADDR_WIDTH] != rd_ptr_gray_sync2_reg[ADDR_WIDTH]) && (wr_ptr_gray_reg[ADDR_WIDTH - 1] != rd_ptr_gray_sync2_reg[ADDR_WIDTH - 1]) && (wr_ptr_gray_reg[ADDR_WIDTH - 2:0] == rd_ptr_gray_sync2_reg[ADDR_WIDTH - 2:0])) ? 1'b1 : 1'b0;

// TODO: check for empty status based on comparison between rd_ptr_gray_reg and wr_ptr_gray_sync2_reg
wire empty = (rd_ptr_gray_reg == wr_ptr_gray_sync2_reg) ? 1'b1 : 1'b0;
...
always @* begin
    ...
    // input data valid
    if (wr_axis_rdy && wr_axis_vld) begin
