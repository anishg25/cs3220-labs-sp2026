...
class alignas(VL_CACHE_LINE_BYTES) Vtb_axi4_ram_burst___024root final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtb_axi4_ram_burst___024root(Vtb_axi4_ram_burst__Syms* symsp, const char* v__name);
