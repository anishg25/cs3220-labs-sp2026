...
`define IDMEMINITFILE "/Users/anish/Documents/cs3220-labs-sp2026/lab3/test/part5/alutest0.mem"
...
`define DE_latch_WIDTH          (32 + 5 + 1 + `INSTBITS + `DBITS + `DBITS + `DBITS + `IOPBITS + `DBITS + `DBITS + `DBITS + 1 + 1 + 1 + 1 + 1 + `REGNOBITS + 8)
`define AGEX_latch_WIDTH        (32 + 5 + 1 + `INSTBITS + `DBITS + `IOPBITS + `DBITS + `DBITS + 1 + 1 + `REGNOBITS + 1)
...
`define from_MEM_to_DE_WIDTH    (32 + 32 + 32)
